...
<script type="text/javascript">
    ...
    function update(productid, status) {
        ...
        $('#test1').load("updateStatusProduct?productid=" + productid +"&status=" +status +"&act=approval");
    ...
    function detail(idProduct, prodCode, prodName, groupid, unitid, info, valuta, harga, pict, condition) {
        ...
        $("#btnprocess").attr("onclick", "update("+ idProduct +" , 2)");
                ...
                <div class="panel-body">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h2>APPROVE ADD PRODUCT REQUEST</h2>
                        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title">APPROVE ADD PRODUCT REQUEST</h2>
            </div>
