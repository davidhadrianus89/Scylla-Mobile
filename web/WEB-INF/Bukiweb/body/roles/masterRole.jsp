                        ...
                        <div class="ibox-content" style="font-family: Trebuchet MS">
                            ...
                            <div id="div_box" class="form-group" style="overflow-x: auto;">
                                <table class="table table-striped table-bordered table-hover " id="tabel1" >
                                    ...
                                    <tbody id="tbody">
                                        <c:forEach var="role" items="${list_role}" varStatus="i">        
                                            <tr>
                                                <td>${i.count}</td>
                                                <td>${role.id}</td>
                                                <td>${role.name}</td>
                                                <td>
                                                    <a data-toggle="modal" onclick="selectRow('${role.id}', '${role.name}')" class="btn btn-sm btn-outline btn-primary" href="#modal-group">
                                                        <i class="fa fa-paste" ></i> 
                                                        Edit
                                                    </a>
                                                    &nbsp;&nbsp;
                                                    <a data-toggle="modal" onclick="hapus('${role.id}')" class="btn btn-sm btn-outline btn-danger" href="#">
