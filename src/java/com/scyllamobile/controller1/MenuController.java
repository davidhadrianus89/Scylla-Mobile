...
import com.scyllamobile.model.TUserMenu;
...
public class MenuController {
    ...
    protected String getLogin(String userId, String groupId) throws Exception {
        String menu = "";
        ...
        for (int i = 0; i < listMenu.size(); i++) {
            TUserMenu userMenu = (TUserMenu) listMenu.get(i);
